...
class GLU(nn.Module):
    def __init__(self, input_channel, output_channel):
        # TODO: Initialize 'linear_left' and 'linear_right' layers.
        super(GLU, self).__init__()
        self.linear_left = nn.Linear(input_channel, output_channel)
        self.linear_right = nn.Linear(input_channel, output_channel)

    def forward(self, x):
        # TODO: Implement forward pass by multiplying self.linear_left(x) with sigmoid of self.linear_right(x).
        return torch.mul(self.linear_left(x), torch.sigmoid(self.linear_right(x)))


class StockBlockLayer(nn.Module):
    # TODO: Implement initialization of 'time_step', 'unit', and 'multi_layer'.
